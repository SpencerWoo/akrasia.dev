...
def upload_compiled_sites(base_dir):
    ...
    sites = ['cyberchef', 'k8s', 'metaljs', 'prng', 'sennajs', 'talon']
...
def upload_nginx(base_dir):
    ...
    # sudo ln -s /etc/nginx/sites-available/puzzle.akrasia.dev /etc/nginx/sites-enabled/
    # sudo ln -s /etc/nginx/sites-available/akrasia.dev /etc/nginx/sites-enabled/
    # sudo ln -s /etc/nginx/sites-available/test.akrasia.dev /etc/nginx/sites-enabled/
